...
class _QuestionScreenState extends State<QuestionScreen> {
  ...
  void _loadQuestions(ProfileModel profile) {
    ...
    final target = profile.isEmployed ? 'employed' : 'unemployed';
    context.read<QuestionCubit>().fetchQuestions(target);
  }
          ...
          child: BlocBuilder<QuestionCubit, QuestionState>(
            builder: (context, questionState) {
              ...
              final isCurrentAnswered =
                  questionState.isAnswered(currentQuestion.id);
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          if ((questionState.validationMessage ?? '').isNotEmpty)
                            Padding(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            value == null ? 'Move the slider to choose a value.' : 'Selected value: $value',
            style: const TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w600,
